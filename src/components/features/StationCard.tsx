...
/**
 * One station's result card — used by the /stations list (Part 06).
 * Every field it shows comes from GET /api/stations (src/services/
 * station-service.ts); nothing here is hard-coded, per docs/
 * architecture.md's rule that station data always comes from the API.
 */
export function StationCard({ station }: { station: StationListItem }) {
