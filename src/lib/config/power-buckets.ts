 ...
 * spec ("Up to 7 kW / 7–22 kW / 22–60 kW / 60–120 kW / 120+ kW / Unknown").
 * Single source of truth for both the filter UI and the server-side query
 ...
 * bound). "Unknown" matches a charger with no recorded power_kw at all —
 * an honest bucket, not a fallback default.
 */

export type PowerBucketId = "UP_TO_7" | "7_TO_22" | "22_TO_60" | "60_TO_120" | "120_PLUS" | "UNKNOWN";
